      ...
      <div className="max-w-md w-full bg-background border-2 border-border-lavender rounded-2xl shadow-lg p-6 sm:p-8">
        ...
        <div className="space-y-3">
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 bg-white border-2 border-gray-300 text-gray-700 py-3 rounded-full font-medium hover:bg-gray-50 transition disabled:opacity-50 disabled:cursor-not-allowed shadow-sm"
          >
